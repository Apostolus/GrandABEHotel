			...
			<div class="collapse navbar-collapse" id="ABENavbar">
				<ul class="nav navbar-nav col-sm-5">
					...
					<li class="dropdown leftNav">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#"><h4><img src="assets/img/ui/arrow.png" class="dropdown-img">The Hotel</h4></a>
						<ul class="dropdown-menu dropdown-menu-right">
							<li><a href="#">About GrandABE</a></li>
				...
				<ul class="nav navbar-nav col-sm-5 ">
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#"><h4><img src="assets/img/ui/arrow.png" class="dropdown-img">Services</h4></a>
						<ul class="dropdown-menu dropdown-menu-right">
